...
# Group by EMPLOYEE_ID and count unique JOB_IDs
employee_jobs_count = df.groupby('EMPLOYEE_ID')['JOB_ID'].nunique()

# Filter employees who have two or more unique JOB_IDs
employees_with_multiple_jobs = employee_jobs_count[employee_jobs_count >= 2]

# Display the IDs of employees who had two or more jobs in the past
